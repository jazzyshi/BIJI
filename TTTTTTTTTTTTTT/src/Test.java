...
/**
 * Created by jzshi on 2019/10/19.
 */
public class Test {
...
//        System.out.println("初始postiond的位置="+buf.position());//postion的初始位置0
//        buf.put(13);// position位置：0 - > 1
//        System.out.println("postiond的位置="+buf.position());
...
//        buf.flip();
//        System.out.println("flip()后的位置="+buf.position());
